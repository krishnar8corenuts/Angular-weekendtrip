...
export class PaymentComponent {
  ...
  constructor(public  repo:WeekendRepository,) {
      ...
      this.ctotalprice=this.totalprice
...
hidemodel(){
  ...
  console.log(this.repo.traveller2)
  this.repo.traveller2.packagePrice=this.ctotalprice;
  this.repo.savetravellerafter();
}
getcoupon1(discount:number){

  if(this.count==0){
    this.count++;
    this.ctotalprice=(this.totalprice-((this.totalprice*discount)/100))
    this.repo.totalprice=this.ctotalprice
  }
  else{
    this.checkcoupon1=false;
  this. checkcoupon2=false;
...
getcoupon2(discount:number){
  if(this.count==0){
    ...
    this.repo.totalprice=this.totalprice
  }
  else{
    this.checkcoupon=false;
    this. checkcoupon2=false;
