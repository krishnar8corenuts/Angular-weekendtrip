...
authorize(formdetails:Login){
  ...
  this.dataSource.login(formdetails).subscribe(
    ...
    this.useremail=formdetails.email;
...
getpdf(id:number){
  ...
  console.log(this.totalprice,"pdf")
 return this.dataSource.getPdf(id,this.totalprice).subscribe(
  (response:any)=>{
...
savetravellerafter(){
  this.dataSource.saveTraveller(this.traveller2).subscribe(
    e=>
